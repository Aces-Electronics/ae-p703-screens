...
lv_arc_set_value(ui_auxBattVoltageArc, 71005);
...
lv_label_set_text(ui_auxBattPercentageLabel,"");
...
lv_obj_set_x( ui_warningLabel, 5 );
lv_obj_set_y( ui_warningLabel, 35 );
...
lv_obj_set_style_text_decor(ui_auxBatteryStateLegend, LV_TEXT_DECOR_UNDERLINE, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_hp1Label, 0 );
lv_obj_set_y( ui_hp1Label, -4 );
lv_obj_set_align( ui_hp1Label, LV_ALIGN_BOTTOM_MID );
...
lv_obj_set_style_text_font(ui_hp1Label, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_hp2Label, 45 );
lv_obj_set_y( ui_hp2Label, -4 );
lv_obj_set_align( ui_hp2Label, LV_ALIGN_BOTTOM_LEFT );
...
lv_obj_set_style_text_font(ui_hp2Label, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_lp1Label, -45 );
lv_obj_set_y( ui_lp1Label, -4 );
lv_obj_set_align( ui_lp1Label, LV_ALIGN_BOTTOM_RIGHT );
...
lv_obj_set_style_text_font(ui_lp1Label, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_decor(ui_auxBatteryStateLegend1, LV_TEXT_DECOR_UNDERLINE, LV_PART_MAIN| LV_STATE_DEFAULT);
