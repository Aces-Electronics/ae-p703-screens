...
lv_obj_set_height( ui_auxBattVoltageArc, 294);
...
lv_obj_set_x( ui_auxBatteryStateLegend, 168 );
lv_obj_set_y( ui_auxBatteryStateLegend, -146 );
lv_obj_set_align( ui_auxBatteryStateLegend, LV_ALIGN_CENTER );
lv_label_set_text(ui_auxBatteryStateLegend,"Aux Batt");
...
lv_obj_set_x( ui_auxBatteryStateLegendColour, 88 );
lv_obj_set_y( ui_auxBatteryStateLegendColour, -145 );
...
lv_obj_set_x( ui_auxState, -182 );
lv_obj_set_y( ui_auxState, -146 );
lv_obj_set_align( ui_auxState, LV_ALIGN_CENTER );
lv_label_set_text(ui_auxState,"Battery State");
...
lv_obj_set_x( ui_auxBattVoltageLabel, 179 );
...
lv_label_set_text(ui_socLabel1,"Mode");
...
lv_obj_set_x( ui_hp1Label, 194 );
lv_obj_set_y( ui_hp1Label, 134 );
...
lv_obj_set_style_text_font(ui_hp1Label, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_hp1Label1 = lv_label_create(ui_batteryStateScreen);
lv_obj_set_width( ui_hp1Label1, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_hp1Label1, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_hp1Label1, 64 );
lv_obj_set_y( ui_hp1Label1, 134 );
lv_obj_set_align( ui_hp1Label1, LV_ALIGN_CENTER );
lv_label_set_text(ui_hp1Label1,"HP2");
lv_obj_clear_flag( ui_hp1Label1, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM | LV_OBJ_FLAG_SCROLL_CHAIN );    /// Flags
lv_obj_set_style_text_color(ui_hp1Label1, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_hp1Label1, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_hp1Label1, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_lp1Label, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_lp2Label, -188 );
lv_obj_set_y( ui_lp2Label, 133 );
...
lv_obj_set_style_text_font(ui_lp2Label, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
