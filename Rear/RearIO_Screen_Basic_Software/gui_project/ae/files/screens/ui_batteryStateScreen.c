...
lv_obj_set_x( ui_auxBatteryStateLegend, 171 );
lv_obj_set_y( ui_auxBatteryStateLegend, -147 );
...
lv_obj_set_x( ui_auxBatteryStateLegendColour, 89 );
lv_obj_set_y( ui_auxBatteryStateLegendColour, -146 );
...
lv_obj_set_x( ui_auxState, -181 );
lv_obj_set_y( ui_auxState, -140 );
...
lv_obj_set_x( ui_auxBattVoltageLabel, 193 );
lv_obj_set_y( ui_auxBattVoltageLabel, -104 );
